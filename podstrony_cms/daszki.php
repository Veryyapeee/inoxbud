                ...
                <div id='navbar'>
                   ...
                   <nav>
                        <ul>
                            ...
                            <li><a href="daszki.php" class='menu-active'>Daszki i zabudowy</a></li>
    ...
    <section id='galleryCon'>
        <div class='gallery_top'>
            ...
            <form action="../include/galeria/updateWholeImg.php" method='POST' enctype='multipart/form-data'>
                ...
                <input type='text' name='kategoria' value='daszki.php' hidden>
                <input type='text' name='tabela' value='daszki' hidden>
                ...
                <div class='img".($i+1)." galeria__img__con'>
                    ...
                    <div class='img_form'>
                        <form action='../include/galeria/updateImg.php' method='POST' id='upload' enctype='multipart/form-data'>
                            ...
                            <input type='text' name='kategoria' value='daszki' hidden>
                            <input type='text' name='strona' value='daszki.php' hidden>
