                ...
                <div id='navbar'>
                   ...
                   <nav>
                        <ul>
                            ...
                            <li><a href="schody.php" class='menu-active'>Schody</a></li>
    ...
    <section id='galleryCon'>
        <div class='gallery_top'>
            ...
            <form action="../include/galeria/updateWholeImg.php" method='POST' enctype='multipart/form-data'>
                ...
                <input type='text' name='kategoria' value='schody.php' hidden>
                <input type='text' name='tabela' value='schody' hidden>
                ...
                <div class='img".($i+1)." galeria__img__con'>
                    ...
                    <div class='img_form'>
                        <form action='../include/galeria/updateImg.php' method='POST' id='upload' enctype='multipart/form-data'>
                            ...
                            <input type='text' name='kategoria' value='schody' hidden>
                            <input type='text' name='strona' value='schody.php' hidden>
