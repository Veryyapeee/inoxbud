                ...
                <div id='navbar'>
                   ...
                   <nav>
                        <ul>
                            ...
                            <li><a href="inne.php" class='menu-active'>Inne</a></li>
    ...
    <section id='galleryCon'>
        <div class='gallery_top'>
            ...
            <form action="../include/galeria/updateWholeImg.php" method='POST' enctype='multipart/form-data'>
                ...
                <input type='text' name='kategoria' value='inne.php' hidden>
                <input type='text' name='tabela' value='inne' hidden>
                ...
                <div class='img".($i+1)." galeria__img__con'>
                    ...
                    <div class='img_form'>
                        <form action='../include/galeria/updateImg.php' method='POST' id='upload' enctype='multipart/form-data'>
                            ...
                            <input type='text' name='kategoria' value='inne' hidden>
                            <input type='text' name='strona' value='inne.php' hidden>
