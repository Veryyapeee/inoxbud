                ...
                <div id='navbar'>
                   ...
                   <nav>
                        <ul>
                            ...
                            <li><a href="ogrodzenia.php" class='menu-active'>Ogrodzenia</a></li>
    ...
    <section id='galleryCon'>
        <div class='gallery_top'>
            ...
            <form action="../include/galeria/updateWholeImg.php" method='POST' enctype='multipart/form-data'>
                ...
                <input type='text' name='kategoria' value='ogrodzenia.php' hidden>
                <input type='text' name='tabela' value='ogrodzenia' hidden>
                ...
                <div class='img".($i+1)." galeria__img__con'>
                    ...
                    <div class='img_form'>
                        <form action='../include/galeria/updateImg.php' method='POST' id='upload' enctype='multipart/form-data'>
                            ...
                            <input type='text' name='kategoria' value='ogrodzenia' hidden>
                            <input type='text' name='strona' value='ogrodzenia.php' hidden>
