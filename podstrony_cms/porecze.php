                ...
                <div id='navbar'>
                   ...
                   <nav>
                        <ul>
                            ...
                            <li><a href="porecze.php" class='menu-active'>Poręcze</a></li>
    ...
    <section id='galleryCon'>
        <div class='gallery_top'>
            ...
            <form action="../include/galeria/updateWholeImg.php" method='POST' enctype='multipart/form-data'>
                ...
                <input type='text' name='kategoria' value='porecze.php' hidden>
                <input type='text' name='tabela' value='porecze' hidden>
                ...
                <div class='img".($i+1)." galeria__img__con'>
                    ...
                    <div class='img_form'>
                        <form action='../include/galeria/updateImg.php' method='POST' id='upload' enctype='multipart/form-data'>
                            ...
                            <input type='text' name='kategoria' value='porecze' hidden>
                            <input type='text' name='strona' value='porecze.php' hidden>
