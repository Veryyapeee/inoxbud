...
<body>
       ...
       <section class="news">
                 ...
                 <?php
                    ...
                    {
                        header("Location: daszki.php?error=MysqlError");
                    } else {
            ...
            <header>
                <div id='navbar'>
                   <a href='http://inoxbud.pl'>
                        <img src="../ASSETS/inoxbud-logo.svg" alt="daszki" title="logo inoxbud" class='logo'>
                    </a>
                   ...
                   <nav>
                    ...
                    <label for="nav-toggle" class="nav-toggle-label">
                        <img src="../ASSETS/hamburger.png" alt="daszki Warszawa" class='hamburger'>
                    </label>
                </div>
        ...
        <article>
            ...
            <div class="galeria__header" style="background-image: url('../ASSETS/daszki-bg.png');">
                Zadaszenia
            </div>
            ...
            <div class="grid__galeria">
              <?php
                ...
                if(!mysqli_stmt_prepare($stmt, $sql))
                {
                    ...
                    for($i = 0; $i<15; $i++) {
                        $z = $i+1;
                        $sql2 = "SELECT * FROM daszki WHERE id='$z';";
                        ...
                        if($rowCount2 < 1 ){
                            ...
                            <a href='../include/galeria/img/".$row2['nazwa']."' data-lightbox='mygallery' data-title='Obraz prezentujący przykładowe zadaszenie Nr".($i+1)."'>
                                <img src='../include/galeria/img/".$row2['nazwa']."' alt='Daszki Warszawa' title='Przykładowy daszek'>
                            </a>
                            <div class='numerZdjecia'>".($i+1)."</div>
                        </div>";
                        }
            ...
            <div class="table ask__table">
                <div class="galeria__ask">
                    ...
                    <div class="ask__con">
                        <img src="../ASSETS/local_phone.png" alt="daszki z drewna" title="telefon" class='phone'>
                        <span class='galeria__nr'>506 130 134</span>
                    </div>
                    <div class="ask__con">
                        <img src="../ASSETS/email.png" alt="daszki na wymiar" title="email" class='mail'>
            ...
            <div class="footerinfo footerinfo-right">
                ...
                <div class='ctname'>
                    ...
                    <div class="facebook__white">
                        <a href='https://www.facebook.com/inoxbud/' target='_blank'>
                            <img src='../ASSETS/facebook-inoxbud-w.png'alt="drewniane daszki" title="www.facebook.com/inoxbud" class='fb'>
                        </a>
                    </div>
            </div>
        </div>
