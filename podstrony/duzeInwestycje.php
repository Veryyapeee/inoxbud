...
<body>
       ...
       <section class="news">
                  <?php
                    ...
                    {
                        header("Location: duzeInwestycje.php?error=MysqlError");
                    } else {
            ...
            <header>
                <div id='navbar'>
                    <a href='http://inoxbud.pl'>
                        <img src="../ASSETS/inoxbud-logo.svg" alt="schody z drewna" title="logo inoxbud" class='logo'>
                    </a>
                   ...
                   <nav>
                    ...
                    <label for="nav-toggle" class="nav-toggle-label">
                        <img src="../ASSETS/hamburger.png" alt="duże inwestycje Warszawa" class='hamburger'>
                    </label>
                </div>
        ...
        <article>
            ...
            <div class="galeria__header" style="background-image: url('../ASSETS/schody-bg.png');">
                Duże Inwestycje
            </div>
                ...
                if(!mysqli_stmt_prepare($stmt, $sql))
                {
                    ...
                    for($i = 0; $i<15; $i++) {
                        ...
                        if($rowCount2 < 1 ){
                            ...
                            <a href='../include/galeria/img/".$row2['nazwa']."' data-lightbox='mygallery' data-title='Obraz prezentujący przykładowy projekt Nr".($i+1)."'>
                                <img src='../include/galeria/img/".$row2['nazwa']."' alt='inwestycje' title='przykładowa inwestycja'>
                            </a>
                            <div class='numerZdjecia'>".($i+1)."</div>
                        </div>";
                        }
            ...
            <div class="galeria__opis">
                ...
                <div class="galeria__fragment">
                    ...
                    Aby wstępna wycena była jak najbardziej zbliżona do ostatecznej prosmy uwzględnić, czy:
                    <ul>
            ...
            <div class="table ask__table">
                <div class="galeria__ask">
                    ...
                    <div class="ask__con">
                        <img src="../ASSETS/local_phone.png" alt="drewno" title="telefon" class='phone'>
                        <span class='galeria__nr'>510 530 252</span>
                    </div>
                    <div class="ask__con">
                        <img src="../ASSETS/local_phone.png" alt="drewniane schody" title="telefon" class='phone'>
                        <span class='galeria__nr'>506 130 134</span>
                    </div>
                    <div class="ask__con">
                        <img src="../ASSETS/email.png" alt="drewniane schody Warszawa" title="emial" class='mail'>
            ...
            <div class="footerinfo footerinfo-right">
                ...
                <div class='ctname'>
                    ...
                    <div class="facebook__white">
                        <a href='https://www.facebook.com/inoxbud/' target='_blank'>
                            <img src='../ASSETS/facebook-inoxbud-w.png' alt="schody na wymiar" title="www.facebook.com/inoxbud"class='fb'>
                        </a>
                    </div>
            </div>
        </div>
...
function initMap() {
  ...
  var map = new google.maps.Map(
      document.getElementById('map__container'), {zoom: 18, center: location});
...
<script  async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCAl_8NIKJgSGbuTmwSTFRH3gta_MitFio&callback=initMap";></script>
