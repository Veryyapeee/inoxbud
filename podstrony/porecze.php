...
<body>
       ...
       <section class="news">
                   <?php
                    ...
                    {
                        header("Location: porecze.php?error=MysqlError");
                    } else {
            ...
            <header>
                <div id='navbar'>
                    <a href='http://inoxbud.pl'>
                        <img src="../ASSETS/inoxbud-logo.svg" alt="poręcze" title="logo inoxbud" class='logo'>
                    </a>
        ...
        <article>
            ...
            <div class="galeria__header" style="background-image: url('../ASSETS/porecze-bg.png');">
                Poręcze
            </div>
            ...
            <div class="grid__galeria">
              <?php
                ...
                if(!mysqli_stmt_prepare($stmt, $sql))
                {
                    ...
                    for($i = 0; $i<15; $i++) {
                        $z = $i+1;
                        $sql2 = "SELECT * FROM porecze WHERE id='$z';";
                        ...
                        if($rowCount2 < 1 ){
                            ...
                            <a href='../include/galeria/img/".$row2['nazwa']."' data-lightbox='mygallery' data-title='Obraz prezentujący przykładowe poręcze Nr".($i+1)."'>
            ...
            <div class="table ask__table">
                <div class="galeria__ask">
                    ...
                    <div class="ask__con">
                        <img src="../ASSETS/local_phone.png" alt="bramy" title="telefon" class='phone'>
                        <span class='galeria__nr'>506 130 134</span>
                    </div>
                    <div class="ask__con">
                        <img src="../ASSETS/email.png" alt="Warszawa" title="email" class='mail'>
