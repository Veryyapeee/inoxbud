...
<body>
       ...
       <section class="news">
                   <?php
                    ...
                    {
                        header("Location: inne.php?error=MysqlError");
                    } else {
            ...
            <header>
                <div id='navbar'>
                   <a href='http://inoxbud.pl'>
                        <img src="../ASSETS/inoxbud-logo.svg" alt="drewno" title="logo inoxbud" class='logo'>
                    </a>
                   ...
                   <nav>
                    ...
                    <label for="nav-toggle" class="nav-toggle-label">
                        <img src="../ASSETS/hamburger.png" alt="schody" class='hamburger'>
                    </label>
                </div>
        ...
        <article>
            ...
            <div class="galeria__header" style="background-image: url('../ASSETS/inne-bg.png');">
                Inne
            </div>
            ...
            <div class="grid__galeria">
              <?php
                ...
                if(!mysqli_stmt_prepare($stmt, $sql))
                {
                    ...
                    for($i = 0; $i<15; $i++) {
                        $z = $i+1;
                        $sql2 = "SELECT * FROM inne WHERE id='$z';";
            ...
            <div class="table ask__table">
                <div class="galeria__ask">
                    ...
                    <div class="ask__con">
                        <img src="../ASSETS/email.png" alt="" class='mail'>
            ...
            <div class="footerinfo footerinfo-right">
                ...
                <div class='ctname'>
                    ...
                    <div class="facebook__white">
                        <a href='https://www.facebook.com/inoxbud/' target='_blank'>
                            <img src='../ASSETS/facebook-inoxbud-w.png'alt="na zamówienie" title="www.facebook.com/inoxbud" class='fb'>
                        </a>
                    </div>
            </div>
        </div>
