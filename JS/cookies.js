...
(function() {
  ...
  var defaults = {
    messageLocales: {
      ...
      pl:
        "Strona korzysta z Ciasteczek w celu zapewnienia jak najlepszego doświadczenia z przeglądania naszej oferty. Jeżeli tylko chcesz, możesz je wyłączyć w ustawieniach przeglądarki."
  ...
  window.cookieNoticeJS = function() {
    ...
    if (params.learnMoreLinkEnabled) {
      var learnMoreLinkText = getStringForCurrentLocale(
    ...
    var dismissButton = createDismissButton(
      buttonText,
  ...
  function createNotice(message, bgColor, textColor, position) {
    ...
    noticeStyle.fontFamily = "Oswald, Helvetica, sans-serif";
    noticeStyle.outline = "2px solid #3d9bea";
    ...
    for (property in properties) {
      if (properties.hasOwnProperty(property)) {
        if (typeof source[property] === "object") {
          source[property] = extendDefaults(
            source[property],
            properties[property]
          );
        } else {
